...
export const faqs: FAQ[] = [
  {
    ...
    answer: 'はい、大丈夫です。これまでのセッション参加者のほとんどがコーチング未経験の方です。構えず、お話しいただくだけで十分です。問いかけを通じて自然と言葉が出てきます。',
    category: 'general'
  },
  {
  ...
  },
  {
    ...
    answer: '1回のセッションでも「自分の判断軸が言語化できた」「次に何をすべきか明確になった」という声をいただいています。ただし、深い変化を求める場合は、3ヶ月間の羅針盤プログラムをおすすめしています。継続的なサポートでより確実に変化を実現できます。',
