      ...
      <section id="section-hero" className="relative flex min-h-screen w-full flex-col items-center justify-center px-4">
        ...
        >
          ...
          >
            ...
            <Link
              href="/contact"
              className="bg-japan-vermilion text-white px-8 py-4 min-h-[48px] rounded-full text-lg font-bold shadow-lg hover:shadow-xl hover:scale-105 transition-all flex items-center gap-2 group"
            >
              無料で相談する
            ...
            <a
              href="#works"
              className="border-2 border-japan-indigo text-japan-indigo px-8 py-4 min-h-[48px] rounded-full text-lg hover:bg-japan-indigo hover:text-white transition-all flex items-center gap-2"
            >
              実績を見る
          ...
          {/* Flow Visualization - subtle step indicator */}
          <motion.div
            variants={itemVariants}
            className="mt-10 flex items-center justify-center gap-2 md:gap-3 text-japan-indigo/30 text-xs md:text-sm select-none"
            aria-label="サイト内の案内フロー"
          >
            <span className="animate-bounce-slow">↓</span>
            <span>サービスを見る</span>
            <span className="text-japan-indigo/20">→</span>
            <span>実績を確認</span>
            <span className="text-japan-indigo/20">→</span>
            <span>無料相談</span>
          </motion.div>
            ...
            {[
              ...
              >
                ...
                >
                  ...
                  <span className="inline-flex items-center gap-1 text-japan-indigo font-medium text-sm group-hover:gap-2 transition-all min-h-[48px] md:min-h-0">
                    詳しく見る
        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          >
            ...
            <div className="text-center md:text-left">
              ...
              <Link
                href="/about"
                className="inline-flex items-center gap-2 text-japan-indigo font-medium hover:gap-3 transition-all mt-4 group min-h-[48px] py-2"
              >
                詳しく見る
          ...
          >
            <div className="flex flex-col md:flex-row items-center justify-center gap-6">
              ...
              <a
                ...
                className="flex items-center gap-2 bg-[#06C755] text-white px-6 py-3 min-h-[48px] rounded-full font-bold hover:brightness-110 transition-all"
              >
