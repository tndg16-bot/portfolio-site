...
const faqs: FAQ[] = [
    ...
    },
    {
      ...
      answer:
        'はい、全く問題ありません。無料AI活用診断では、AIの基礎から丁寧にご説明します。実際にその場でデモをお見せしますので、知識ゼロでも安心してご参加いただけます。',
      category: 'AI活用',
    },
    {
      id: 'faq-14',
      question: 'どんな業種でもAI活用できますか？',
      answer:
        'はい。不動産、飲食、士業、サービス業、小売など幅広い業種に対応しています。業種ごとの課題に合わせた最適なAI活用法をご提案いたします。',
      category: 'AI活用',
    },
    {
      id: 'faq-15',
      question: 'AI活用支援の料金はいくらですか？',
      answer:
        '無料のAI活用診断（30分）からスタートできます。その後、ワークショップ（10,000円〜）、3ヶ月コンサルティング（月50,000円）、継続サポート（月10,000円）と、段階的にご利用いただけます。詳細はサービスページをご覧ください。',
      category: '料金',
    },
    {
      id: 'faq-16',
      question: '無料AI活用診断では何をしますか？',
      answer:
        '30分のオンラインセッションで、あなたの業務フローをヒアリングし、AIで改善できるポイントを3つまで特定します。さらに、その場で1つのAI活用デモを実演し、「本当に使えるんだ」を体験していただきます。',
      category: 'AI活用',
    },
  ];
