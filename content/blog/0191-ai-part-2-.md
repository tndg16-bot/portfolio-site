...
tags:
  ...
  - 自動化
  - プロンプト
description: "AIに代替されないスキルは何か。これからの時代に必要な学びを考えます。"
published: true
---

## はじめに

AIに代替されないスキルは何か。これからの時代に必要な学びを考えます。
...
AI時代の学習法 Part 2 - 何を学ぶべきかを理解し実践することで、あなたの仕事や生活はより豊かになります。
